...
var app = (function () {
    ...
    const getUserAccount = async (user = {}) => {
       const { data, status } = await axios$1.post(BASE_URL + '/sing-in', {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path0, file$8, 13, 9, 412);
    			...
    			add_location(path1, file$8, 17, 9, 802);
    			...
    			add_location(path2, file$8, 21, 9, 2401);
    			...
    			add_location(path3, file$8, 25, 9, 3609);
    			attr_dev(g0, "transform", "translate(0 540.36)");
    			add_location(g0, file$8, 12, 6, 366);
    			...
    			add_location(linearGradient, file$8, 45, 9, 4637);
    			...
    			add_location(path7, file$8, 57, 9, 5098);
    			add_location(g2, file$8, 44, 6, 4623);
    			...
    			add_location(path8, file$8, 63, 9, 5426);
    			...
    			add_location(path9, file$8, 67, 9, 5716);
    			add_location(g3, file$8, 62, 6, 5412);
    			attr_dev(g4, "transform", "matrix(1.0004 0 0 1.0002 938.58 -540.54)");
    			add_location(g4, file$8, 11, 3, 302);
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			attr_dev(h3, "class", "label__title svelte-1lbwk4o");
    			add_location(h3, file$7, 29, 12, 1012);
    			attr_dev(input, "class", "form__input dt dt-2-matrix svelte-1lbwk4o");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "user_mail");
    			attr_dev(input, "autocomplete", "off");
    			add_location(input, file$7, 30, 12, 1064);
    			attr_dev(label, "for", "user_mail");
    			attr_dev(label, "class", "form__label svelte-1lbwk4o");
    			add_location(label, file$7, 28, 9, 955);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			add_location(span, file$7, 26, 9, 921);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "ctx-caption svelte-1lbwk4o");
    			add_location(span0, file$7, 45, 9, 1693);
    			add_location(span1, file$7, 47, 12, 1787);
    			attr_dev(div, "class", "form--footer svelte-1lbwk4o");
    			add_location(div, file$7, 46, 9, 1747);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(link.$$.fragment);
    			attr_dev(span0, "class", "ctx-caption svelte-1lbwk4o");
    			add_location(span0, file$7, 39, 9, 1469);
    			add_location(span1, file$7, 41, 12, 1560);
    			attr_dev(div, "class", "form--footer svelte-1lbwk4o");
    			add_location(div, file$7, 40, 9, 1520);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_default_slot_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(49:12) <Link to=\\\"/\\\" class=\\\"link\\\">",
    		ctx
    	});
    ...
    // (43:12) <Link to="/register" class="link">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(43:12) <Link to=\\\"/register\\\" class=\\\"link\\\">",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "logo-contain svelte-1lbwk4o");
    			add_location(div0, file$7, 17, 3, 520);
    			attr_dev(h30, "class", "label__title svelte-1lbwk4o");
    			add_location(h30, file$7, 22, 9, 733);
    			attr_dev(input0, "class", "form__input dt dt-2-matrix svelte-1lbwk4o");
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "id", "username");
    			add_location(input0, file$7, 23, 9, 782);
    			attr_dev(label0, "for", "username");
    			attr_dev(label0, "class", "form__label svelte-1lbwk4o");
    			add_location(label0, file$7, 21, 6, 680);
    			attr_dev(h31, "class", "label__title svelte-1lbwk4o");
    			add_location(h31, file$7, 35, 9, 1249);
    			attr_dev(input1, "class", "form__input dt dt-2-matrix svelte-1lbwk4o");
    			attr_dev(input1, "type", "password");
    			attr_dev(input1, "id", "password");
    			attr_dev(input1, "autocomplete", "new-password");
    			add_location(input1, file$7, 36, 9, 1298);
    			attr_dev(label1, "for", "password");
    			attr_dev(label1, "class", "form__label svelte-1lbwk4o");
    			add_location(label1, file$7, 34, 6, 1196);
    			add_location(button, file$7, 51, 6, 1901);
    			attr_dev(form, "action", "#");
    			attr_dev(form, "class", "formControl svelte-1lbwk4o");
    			attr_dev(form, "autocomplete", "off");
    			add_location(form, file$7, 20, 3, 578);
    			attr_dev(div1, "class", "form-container dt svelte-1lbwk4o");
    			add_location(div1, file$7, 16, 0, 484);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class WgAuthForm extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { isAuth: 0 });
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 6, 3, 135);
    			attr_dev(main, "class", "main-home");
    			add_location(main, file$6, 5, 0, 106);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			span3 = element("span");
    			span3.textContent = "OPTIONS";
    			t11 = space();
    			span4 = element("span");
    			span4.textContent = "FRIENDS";
    			t13 = space();
    			div3 = element("div");
    			div1 = element("div");
    			div1.textContent = "Hola Amigos";
    			t15 = space();
    			div2 = element("div");
    			div2.textContent = "Hola Muvjahos";
    			attr_dev(span0, "class", "menu__logo svelte-3743hq");
    			add_location(span0, file$5, 22, 6, 458);
    			attr_dev(span1, "class", "close");
    			add_location(span1, file$5, 25, 9, 566);
    			attr_dev(span2, "class", "user--section");
    			add_location(span2, file$5, 23, 6, 505);
    			attr_dev(button, "class", "menu--toggle svelte-3743hq");
    			add_location(button, file$5, 27, 6, 646);
    			attr_dev(nav0, "class", "menu menu--top");
    			add_location(nav0, file$5, 21, 3, 422);
    			add_location(p, file$5, 33, 12, 899);
    			attr_dev(section0, "class", "user--constants");
    			add_location(section0, file$5, 32, 9, 852);
    			attr_dev(span3, "role", "button");
    			attr_dev(span3, "class", "svelte-3743hq");
    			add_location(span3, file$5, 37, 15, 1029);
    			attr_dev(span4, "role", "button");
    			attr_dev(span4, "class", "active svelte-3743hq");
    			add_location(span4, file$5, 38, 15, 1116);
    			attr_dev(div0, "class", "tab__labels svelte-3743hq");
    			add_location(div0, file$5, 36, 12, 987);
    			attr_dev(div1, "class", "tab options active svelte-3743hq");
    			add_location(div1, file$5, 41, 15, 1242);
    			attr_dev(div2, "class", "tab friends svelte-3743hq");
    			add_location(div2, file$5, 42, 15, 1334);
    			attr_dev(div3, "class", "tab--options");
    			add_location(div3, file$5, 40, 12, 1199);
    			attr_dev(section1, "class", "user__actions");
    			add_location(section1, file$5, 35, 9, 942);
    			attr_dev(div4, "class", "user--section");
    			add_location(div4, file$5, 31, 6, 814);
    			attr_dev(nav1, "class", "menu menu--left dt-l-r");
    			toggle_class(nav1, "is-active", /*active*/ ctx[1]);
    			add_location(nav1, file$5, 30, 3, 745);
    			attr_dev(header, "class", "main-header");
    			add_location(header, file$5, 20, 0, 389);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(span1, "click", /*logoutUser*/ ctx[5], false, false, false),
    					listen_dev(button, "click", /*activeMenu*/ ctx[3], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*data*/ 1 && t2_value !== (t2_value = /*data*/ ctx[0].user + "")) set_data_dev(t2, t2_value);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			button = element("button");
    			attr_dev(input, "class", "input svelte-8m8cvu");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Writte your message");
    			add_location(input, file$3, 11, 6, 354);
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 12, 6, 452);
    			attr_dev(form, "class", "matrix--box");
    			attr_dev(form, "action", "#");
    			add_location(form, file$3, 10, 3, 269);
    			attr_dev(div, "class", "message--input svelte-8m8cvu");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$messages*/ 1) message_changes.user = /*msg*/ ctx[1].owner.username;
    			if (dirty & /*$messages*/ 1) message_changes.message = /*msg*/ ctx[1].message;
    			if (dirty & /*$messages*/ 1) message_changes.date = /*msg*/ ctx[1].date;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(8:3) {#each $messages as msg}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 6, 0, 178);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 21, 0, 619);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:3) <Route path=\\\"/register\\\">",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:3) <AuthRoute path=\\\"/live\\\">",
    		ctx
    	});
    ...
    // (14:3) <AuthRoute path="/hola">
    function create_default_slot_2(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Hello thisis a route for users indefiquers");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(14:3) <AuthRoute path=\\\"/hola\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(authroute0.$$.fragment);
    			t2 = space();
    			create_component(authroute1.$$.fragment);
    			t3 = space();
    		...
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, t1, anchor);
    			mount_component(authroute0, target, anchor);
    			insert_dev(target, t2, anchor);
    			mount_component(authroute1, target, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			const authroute0_changes = {};

    			if (dirty & /*$$scope*/ 1) {
    				authroute0_changes.$$scope = { dirty, ctx };
    			}

    			authroute0.$set(authroute0_changes);
    			const authroute1_changes = {};

    			if (dirty & /*$$scope*/ 1) {
    				authroute1_changes.$$scope = { dirty, ctx };
    			}

    			authroute1.$set(authroute1_changes);
    		...
    		i: function intro(local) {
    			...
    			transition_in(authroute0.$$.fragment, local);
    			transition_in(authroute1.$$.fragment, local);
    		...
    		o: function outro(local) {
    			...
    			transition_out(authroute0.$$.fragment, local);
    			transition_out(authroute1.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			...
    			if (detaching) detach_dev(t1);
    			destroy_component(authroute0, detaching);
    			if (detaching) detach_dev(t2);
    			destroy_component(authroute1, detaching);
